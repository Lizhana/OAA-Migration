  ...
  return (
    <div className={styles.communities}>
      <div className={styles.introduction}>
        ...
        <p className={styles.sub}>Te invitamos a que ingreses en nuestra Sección de Comunidades, para que conozcas las causas por las que luchan los demás, recuerda que tú puedes ser parte importante, así que sal y apoya, porque tú también eres parte de la solución</p>
      </div>
